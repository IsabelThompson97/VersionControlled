...
STRUCT_DIR="${FINAL_DIR}/struct_\${STRUCT_IDX}"
mkdir -p \${STRUCT_DIR}
...
autoimage
trajout struct.ncrst restart netcdf
trajout struct.rst restart
trajout struct.rst7 restart netcdf
...
log "    2. Final structures:         ls ${FINAL_DIR}/struct_*/struct.pdb"
