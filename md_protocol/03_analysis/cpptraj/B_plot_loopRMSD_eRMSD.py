...
# native="1hs3.pdb"
# traj = "../../stripped_trajectories/1hs3foldedHRM_production.nc"
# top = "../../stripped_trajectories/1hs3foldedHRM_stripped.prmtop"
...
mindist = data['MinimumDistanceEnds'].values
...
#plt.xlim(left=0)  # Start at 0 to show the line at 0.7 clearly
plt.tight_layout()
